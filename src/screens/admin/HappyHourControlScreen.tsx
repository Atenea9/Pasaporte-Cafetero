...
export default function HappyHourControlScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.title}>CONTROL HAPPY HOUR</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 18, fontWeight: '900', color: '#C8860A', letterSpacing: 2, textAlign: 'center' },
