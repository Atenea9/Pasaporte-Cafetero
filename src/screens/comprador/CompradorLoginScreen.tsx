...
const T = {
  ...
  muted: '#8A7060', gold: '#B8860B', blue: '#1565C0', border: '#E8D5B0',
};
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.header}>
            ...
            <Text style={s.headerSub}>Ingresa con tu cédula o número de teléfono registrado como comprador internacional</Text>
          </View>
          <View style={s.toggle}>
            <TouchableOpacity style={[s.toggleBtn, mode === 'cedula' && s.toggleBtnActive]} onPress={() => setMode('cedula')}>
              <Text style={[s.toggleText, mode === 'cedula' && s.toggleTextActive]}>🪪 Cédula</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[s.toggleBtn, mode === 'phone' && s.toggleBtnActive]} onPress={() => setMode('phone')}>
...
const s = StyleSheet.create({
  ...
  headerSub:    { fontSize: 13, color: T.muted, textAlign: 'center', lineHeight: 20, paddingHorizontal: 10 },
  ...
  label:        { fontSize: 10, fontWeight: '800', color: T.blue, letterSpacing: 1, marginBottom: 8 },
  input:        { backgroundColor: T.card, borderWidth: 1.5, borderColor: T.border, borderRadius: 14, padding: 16, fontSize: 16, color: T.dark },
  loginBtn:     { backgroundColor: T.blue, borderRadius: 16, padding: 18, alignItems: 'center' },
